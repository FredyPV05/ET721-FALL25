...
class TestMainFunction(unittest.TestCase):
    ...
    # LAB EXERCISE: Create a unittest for invalid data type, for example when the user input strings
    patch("builtins.input", side_effect=["-1", "Andy", "#", "95", "110", "80"])

    @patch("sys.stdout", new_callable=io.StringIO)
    def test_invalid_data_input(self, mock_stdout, mock_input):
        studentsgrade.main()
        output = mock_stdout.getvalue()
