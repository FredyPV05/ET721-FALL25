...
class TestCalculation(unittest.TestCase):
    ...
    def test_addition(self):
        self.assertEqual(calculations.addthreenumbers(8, 7, 3), 18)
        self.assertEqual(calculations.addthreenumbers(8, 7), 15)
        self.assertEqual(calculations.addthreenumbers(8), 8)
